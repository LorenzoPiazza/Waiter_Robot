...
public static final String topicForWaiterLogicResponse = "/topic/displayWaiterLogic";
public static final String topicForSmartbellResponse = "/topic/displaySmartbell";
public static final String topicForClient1Response = "/topic/displayClient1";
public static final String topicForClient2Response = "/topic/displayClient2";
