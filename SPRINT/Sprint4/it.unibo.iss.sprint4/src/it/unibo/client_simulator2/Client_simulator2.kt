...
package it.unibo.client_simulator2
...
class Client_simulator2 ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
				...
				state("listening") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("maxStayTime(CID,CSTATE)"), Term.createTerm("maxStayTime(CID,CSTATE)"), 
								...
								updateResourceRep("CLIENT at table 2 | MAX STAY TIME OVER!" 
								)
								delay(14000) 
						}
						updateResourceRep("CLIENT at table 2 | NO client" 
						)
					}
					 transition(edgeName="t046",targetState="consultMenu",cond=whenDispatch("table_reached"))
				}	 
				state("consultMenu") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("table_reached(CID)"), Term.createTerm("table_reached(CID)"), 
								...
								updateResourceRep("CLIENT at table 2 | I consult the menu..." 
								)
						}
					}
					 transition(edgeName="t047",targetState="order",cond=whenDispatch("proceed"))
					transition(edgeName="t048",targetState="listening",cond=whenDispatch("maxStayTime"))
				}	 
				...
				state("consume") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("tea_served(CID)"), Term.createTerm("tea_served(CID)"), 
								...
								updateResourceRep("CLIENT at table 2 | I drink the tea..." 
								)
						}
					}
					 transition(edgeName="t050",targetState="pay",cond=whenDispatch("proceed"))
					transition(edgeName="t051",targetState="listening",cond=whenDispatch("maxStayTime"))
				}	 
